...
export default class extends AbstractView {
    constructor() {
        super();
        this.setTitle("Log In | Funding Easy");
    }
        ...
        const renderState = () => {
            if (currentState === 'CREDENTIALS') {
                cardContent.innerHTML = `
                    <h1>Welcome back</h1>
                    <p class="subtitle">Log in to your private capital dashboard.</p>
                    <div class="trust-line" style="border: 1px solid var(--border-subtle); background: rgba(243, 234, 215, 0.02); color: var(--text-muted);">
                        ...
                        Secure access for verified founders, investors, and internal teams.
                    </div>
                    ...
                    <form id="loginForm" class="auth-form" novalidate>
                        ...
                        <div style="font-size: 0.75rem; color: #8F9CAE; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 8px;">
                            <span>🔒 TLS 1.3 Encryption Active</span>
                            <span>Rate Limiting: Nominal</span>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <p class="support-path">
                                Need help signing in? <a href="mailto:support@fundingeasy.in" id="supportLink">Contact support</a>
                            </p>
                        </div>
                    </form>
                `;
                ...
                if (location.search.includes('reason=timeout')) {
                    ...
                    stateAlert.textContent = 'Your session has expired due to inactivity. Please log in again.';
                ...
                document.getElementById('forgotPasswordLink').addEventListener('click', (e) => {
                    ...
                    stateAlert.style.display = 'flex';
                    stateAlert.textContent = 'Password reset is disabled in sandbox. Please contact security support.';
                });
                ...
                cardContent.innerHTML = `
                    ...
                    <form id="deviceForm" class="auth-form" novalidate>
                        <div style="font-size: 0.75rem; color: #8F9CAE; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 8px;">
                            <span>🔒 Device Verification Gating</span>
